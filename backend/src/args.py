...
class Args:
    ...
    def parse(self, argv: Sequence[str], meta: dict[str, Any]) -> tuple[dict[str, Any], CustomArgumentParser, list[str]]:
        ...
        parser.add_argument('-s', '--screens', '-screens', nargs=1, required=False, help="Number of screenshots", default=int(self.config['DEFAULT']['screens']))
        ...
        parser.add_argument('-c', '--category', nargs=1, required=False, help="Category [movie, tv, 18, 12, 31, 17, 4, 14, 40, 34, 7, etc.]", type=str, dest="manual_category")
        parser.add_argument('-t', '--type', nargs=1, required=False, help="Type [DISC, REMUX, ENCODE, WEBDL, WEBRIP, HDTV, DVDRIP, OTHER]", choices=['disc', 'remux', 'encode', 'webdl', 'web-dl', 'webrip', 'hdtv', 'dvdrip', 'other'], dest="manual_type")
        ...
        parser.add_argument('-res', '--resolution', nargs=1, required=False, help="Resolution [2160p, 1080p, 1080i, 720p, 576p, 576i, 480p, 480i, OTHER]", choices=['2160p', '1080p', '1080i', '720p', '576p', '576i', '480p', '480i', 'other'])
        parser.add_argument('-name', '--name', nargs='+', required=False, help="Manual Torrent Name override", type=str, dest="manual_name")
        ...
        parser.add_argument('-discogs', '--discogs', nargs=1, required=False, help="Discogs ID", type=str, dest='discogs_manual')
        ...
        parser.add_argument('--dry-run', action='store_true', required=False, help="Identify the release and output metadata as JSON, then exit.", default=False)
        ...
        parser.add_argument('-ih', '--imghost', nargs=1, required=False, help="Image Host", choices=['slikethr', 'imgbb', 'ptpimg', 'imgbox', 'pixhost', 'lensdump', 'ptscreens', 'onlyimage', 'dalexni', 'zipline', 'passtheimage', 'seedpool_cdn', 'utppm'])
        ...
        parser.add_argument('-client', '--client', required=False, help="Use this torrent client instead of default")
