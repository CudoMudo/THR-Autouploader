...
class strit:  # EDIT 'UNIT3D_TEMPLATE' AS ABBREVIATED TRACKER NAME
    def __init__(self, config: Config) -> None:
        super().__init__(config, tracker_name='strit')  # EDIT 'UNIT3D_TEMPLATE' AS ABBREVIATED TRACKER NAME
        self.config = config
        self.common = COMMON(config)
        self.tracker = 'strit'
        self.base_url = 'https://thr.strit.win'
