            ...
            try:
                ...
                if results:
                    ...
                    if len(limited_results) == 1:
                        ...
                        if debug:
                            console.print(f"[green]Auto-selecting best match: {sorted_results[0].get('title') or sorted_results[0].get('name')} (similarity: {results_with_similarity[0][1]:.2f})[/green]")
                        tmdb_id = int(sorted_results[0]['id'])
                        return tmdb_id, category
